...
export class ProdcutService {
  products_list: any[] = [
    ...
    },
    {
      ...
      status: 'active',
      category: 'Vivo',
      images: ['https://krstoreapi.phalla.lol/images/products/vivo Y17s.png'],
    },
    {
      id: 44,
      name: 'Vivo Y12',
      ...
      stock: 12,
      description:
        'Vivo Y12 2023 Price in Saudi Arabia (KSA) April 2024 - Mobileinto Saudi Arabia (KSA)',
      status: 'active',
      category: 'Vivo',
      images: [
    ...
    },
    {
      ...
      status: 'active',
      category: 'Accessories',
      images: ['https://krstoreapi.phalla.lol/images/products/MW2H3.png'],
    },
    {
      id: 49,
      ...
      stock: 23,
      description:
        'The Nimble Fold 3-in-1 Wireless Charger is a sleek and foldable solution to power your entire Apple ecosystem.',
      status: 'active',
      category: 'Accessories',
      images: ['https://krstoreapi.phalla.lol/images/products/HRW22.jpg'],
    },
  ];
